...
class StatisticsAnalyzer:
    ...
    def __init__(self, combinations):
        ...
        self.property_mapping = {
            ...
            'Hydrophobicity': {'unit': 'logP', 'short_name': 'hydrophobicity'},
        ...
        self.alt_property_names = {
            ...
            'hydrophobicity': ['Hydrophobicity', 'LogP', 'hydrophobicity', 'log_p'],
    ...
    def plot_property_boxplots(self, figsize=(12, 8)):
        """Create boxplots for all properties"""
        stats_data = self.calculate_statistics()
        ...
        for prop_name, stats in stats_data.items():
            ...
            if len(values) > 0:
                ...
                labels.append(f"{stats['name']}\n({stats['unit']})")
        
        if not plot_data:
            return None, "No data available for boxplots"
        ...
        # Set labels
        ax.set_title("Property Distributions (Boxplots)")
        ax.set_ylabel("Value")
